                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php while($row = $result->fetch_assoc()) { ?>
                        <tr>
                          ...
                          <td><a href="<?php echo "editCategory.php?id={$row['id']}"; ?>"><img src="./images/edit.png" alt="Edit"></a></td>
                          <td><a href="<?php echo "categories.php?delete={$row['id']}"; ?>"><img src="./images/delete.png" alt="Delete"></a></td>
                        </tr>
                      <?php } ?>
