...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $mysqli->prepare("UPDATE tags SET name = ? WHERE id = ?");
...
<html lang="en">
  <head>
	...
	<title>Images Admin | Edit Tag</title>
									...
									<form method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="name" id="add-category" required="required" class="form-control" value="<?php echo $tag['name'] ?>">
											</div>
										</div>
