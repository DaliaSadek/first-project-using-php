                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <?php while($row = $result->fetch_assoc()) { ?>
                        <tr>
                          ...
                          <td><?php echo $row['is_active'] ? "True" : "False"; ?></td>
                          <td><a href="<?php echo "editPhoto.php?id={$row['id']}"; ?>"><img src="./images/edit.png" alt="Edit"></a></td>
                          <td><a href="<?php echo "photos.php?delete={$row['id']}"; ?>"><img src="./images/delete.png" alt="Delete"></a></td>
                        </tr>
                        <?php } ?>
