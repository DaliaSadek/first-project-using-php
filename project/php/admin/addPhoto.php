...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	if($file_name=uploadImage($file)){
		...
		$stmt = $mysqli->prepare("INSERT INTO photos (title, file, license, user_id, tag_id, dimension, format, is_active, date) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
		$stmt->bind_param("sssssssss", $title, $file_name, $license, $user_id, $tag_id, $dimension, $format, $is_active, $date);
									...
									?> 
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input name="date" type="date" id="photo-date" required="required" class="form-control ">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<textarea name="license" id="content" name="license" required="required" class="form-control">License</textarea>
											</div>
										</div>
										<div class="item form-group">
											<label for="dimension" class="col-form-label col-md-3 col-sm-3 label-align">Dimension <span class="required">*</span></label>
											<div class="col-md-6 col-sm-6 ">
												<input name="dimension" id="dimension" class="form-control" type="text" name="dimension" required="required">
											</div>
										</div>
										<div class="item form-group">
											<label for="format" class="col-form-label col-md-3 col-sm-3 label-align">Format <span class="required">*</span></label>
											<div class="col-md-6 col-sm-6 ">
												<input name="format" id="dimension" id="format" class="form-control" type="text" name="format" required="required">
											</div>
										</div>
										<div class="item form-group">
