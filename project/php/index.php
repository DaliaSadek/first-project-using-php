...
$countQuery = "SELECT COUNT(*) as total FROM Photos WHERE is_active=1";
...
$query = "SELECT * FROM Photos WHERE is_active=1 LIMIT $start, $resultsPerPage";
            ...
            <div class="col-12 d-flex justify-content-between align-items-center tm-paging-col">
                ...
                <?php for ($page = 1; $page <= $totalPages; $page++) : ?>
                    <?php if ($page == $currentPage) : ?>
                        <a href="?page=<?php echo $page; ?>" class="tm-paging-link active"><?php echo $page; ?></a>
                    <?php else : ?>
                        <a href="?page=<?php echo $page; ?>" class="tm-paging-link"><?php echo $page; ?></a>
                    <?php endif; ?>
                <?php endfor; ?>
                </div>
